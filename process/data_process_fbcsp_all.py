...
class FBCSP_Processor:
    def __init__(self, root_output_dir, n_csp_components=8, sfreq=128):
        ...
        print(f"FBCSP initialized: 55 frequency bands are ready")
    ...
    def process_and_save(self, file_path, dataset_type):
        ...
        try:
            if dataset_type == 'BCIC IV 2a':
                ...
                # PhysioNet requires special handling: S001R04.edf -> Subject S001
                # process_physionet will automatically find R04,08,12
